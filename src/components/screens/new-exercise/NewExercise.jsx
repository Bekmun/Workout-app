...
const NewExercise = () => {
	...
	const { isSuccess, error, isLoading, mutate } = useMutation(['create exercise'], (body) => ExerciseService.create(body), {
		onSuccess: () => {
			reset()
		}
	})
	...
	return (
		<>
			<Layout bgImg='../../../../public/images/new-exercise-bg.jpg'
				heading='Create new exercise' backLink='/new-workout' />
							...
							<div className={styles.images}>
								{data.map(name => (
									<img key={`ex img ${name}`}
										...
										onClick={() => onClick(getIconPath(name))}
										draggable={false}
										height='45' />
								))}
							</div>
